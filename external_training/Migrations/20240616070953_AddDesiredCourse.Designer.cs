...
namespace external_training.Migrations
{
    ...
    [Migration("20240616070953_AddDesiredCourse")]
    partial class AddDesiredCourse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("external_training.Models.DesiredCourse", b =>
                {
                    b.Property<int>("DesiredCourseId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("DesiredCourseId"));
            ...
            modelBuilder.Entity("external_training.Models.DesiredCourse", b =>
                {
                    b.HasOne("external_training.Models.TrainingApplication", "TrainingApplication")
                        .WithOne("DesiredCourse")
                        .HasForeignKey("external_training.Models.DesiredCourse", "TrainingApplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
