        ...
        return (
            <div className="flex flex-col mx-auto max-w-2xl gap-[50px] py-16">
                ...
                <CardWithColumn>
                    ...
                    <TextField label='Отдел/команда' placeholder='Команда разработки «Во!»' value={team}
                               onChange={setTeam}/>
                    <TextField label='Должность' placeholder='ui/ux дизайнер junior' value={jobTitle}
                               onChange={setJobTitle}/>
                    <TextField label='Руководитель' placeholder='Петров Пётр Петрович' value={manager}
                               onChange={setManager}/>
                </CardWithColumn>
